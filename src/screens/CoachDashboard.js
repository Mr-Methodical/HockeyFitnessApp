      ...
      {!team ? (
        ...
        <>
          ...
          <View style={[styles.teamCard, { backgroundColor: isDarkMode ? '#1E1E1E' : '#FFFFFF' }]}>
            <View style={styles.teamHeader}>
              <View style={styles.teamInfo}>
                ...
                <Text style={[styles.teamCode, { color: isDarkMode ? '#CCC' : '#666666' }]}>Team Code: {team.code}</Text>
              </View>
              <TouchableOpacity 
          ...
          <View style={styles.statsContainer}>
            <View style={[styles.statCard, { backgroundColor: isDarkMode ? '#1E1E1E' : '#FFFFFF' }]}>
              <Text style={[styles.statNumber, { color: currentTheme.primary }]}>{stats.activeMembers}</Text>
              <Text style={[styles.statLabel, { color: isDarkMode ? '#CCC' : '#666666' }]}>Players</Text>
            </View>
            <View style={[styles.statCard, { backgroundColor: isDarkMode ? '#1E1E1E' : '#FFFFFF' }]}>
              <Text style={[styles.statNumber, { color: currentTheme.primary }]}>{stats.thisWeekWorkouts}</Text>
              <Text style={[styles.statLabel, { color: isDarkMode ? '#CCC' : '#666666' }]}>This Week</Text>
            </View>
            <View style={[styles.statCard, { backgroundColor: isDarkMode ? '#1E1E1E' : '#FFFFFF' }]}>
              <Text style={[styles.statNumber, { color: currentTheme.primary }]}>{stats.totalWorkouts}</Text>
              <Text style={[styles.statLabel, { color: isDarkMode ? '#CCC' : '#666666' }]}>Total Workouts</Text>
            </View>
          </View>
          ...
          <View style={styles.actionsContainer}>
            <TouchableOpacity 
              style={[styles.actionButton, { 
                ...
                borderColor: isDarkMode ? '#007AFF' : currentTheme.secondary 
              }]}
              onPress={() => navigation.navigate('Messages')}
            >
              <MaterialIcons name="message" size={24} color={isDarkMode ? '#007AFF' : currentTheme.secondary} />
              <Text style={[styles.actionButtonText, { color: isDarkMode ? '#007AFF' : currentTheme.secondary }]}>Message</Text>
            </TouchableOpacity>
            <TouchableOpacity 
              style={[styles.actionButton, { 
                backgroundColor: isDarkMode ? '#2C2C2E' : '#FFFFFF', 
            ...
            >
              <MaterialIcons name="leaderboard" size={24} color={isDarkMode ? '#007AFF' : currentTheme.secondary} />
              <Text style={[styles.actionButtonText, { color: isDarkMode ? '#007AFF' : currentTheme.secondary }]}>Leaders</Text>
            </TouchableOpacity>
            <TouchableOpacity 
              style={[styles.actionButton, { 
                backgroundColor: isDarkMode ? '#2C2C2E' : '#FFFFFF', 
            ...
            >
              <MaterialIcons name="history" size={24} color={isDarkMode ? '#007AFF' : currentTheme.secondary} />
              <Text style={[styles.actionButtonText, { color: isDarkMode ? '#007AFF' : currentTheme.secondary }]}>History</Text>
            </TouchableOpacity>
          </View>
