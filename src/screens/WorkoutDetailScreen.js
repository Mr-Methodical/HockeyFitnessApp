    ...
    >
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.workoutTime}>{formatTime(workout.timestamp)}</Text>
          ...
          {workout.userName && workout.userId && (
            <View style={styles.userInfo}>
              ...
              >
                ...
                <MaterialIcons name="arrow-forward-ios" size={12} color="#007AFF" />
              </TouchableOpacity>
            </View>
          )}
          ...
          {workout.isAIGenerated && (
            <View style={styles.aiWorkoutBadge}>
              ...
              <Text style={styles.aiWorkoutBadgeText}>AI Generated Workout</Text>
            </View>
          )}
          ...
          {workout.userId !== user?.uid && (
            <TouchableOpacity 
              style={styles.generateSimilarButton}
        ...
        {workout.isAIGenerated && workout.exercises && (
          <View style={styles.exercisesCard}>
            <Text style={styles.exercisesTitle}>Workout Details</Text>
            
            {/* Workout Summary */}
            {workout.difficulty && (
              <View style={styles.workoutSummary}>
                <Text style={styles.summaryLabel}>Difficulty: </Text>
                <Text style={styles.summaryValue}>{workout.difficulty}</Text>
                {workout.estimatedDuration && (
                  <>
                    <Text style={styles.summaryLabel}> • Estimated: </Text>
                    <Text style={styles.summaryValue}>{workout.estimatedDuration}</Text>
                  </>
                )}
              </View>
            )}
        ...
        <View style={styles.likeCard}>
          ...
          >
            <MaterialIcons 
              ...
              size={24} 
              color={likes.includes(user?.uid) ? "#007AFF" : "#8E8E93"} 
            />
            <Text style={[
              styles.likeButtonText,
              likes.includes(user?.uid) && styles.likeButtonTextActive
            ]}>
