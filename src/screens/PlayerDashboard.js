      ...
      {!team ? (
        ...
        <>
          ...
          <View style={[styles.teamCard, { backgroundColor: currentTheme.surface }]}>
            ...
            <Text style={[styles.teamInfo, { color: currentTheme.textSecondary }]}>
              {isGroupMember ? 
            ...
            {isGroupMember && team.code && (
              <Text style={[styles.groupCode, { color: currentTheme.textSecondary }]}>
          ...
          <View style={styles.actionsContainer}>
            ...
            {!isGroupMember && (
              <TouchableOpacity 
                style={[styles.messagesButton, { borderColor: currentTheme.secondary, backgroundColor: currentTheme.surface }]}
            ...
            <TouchableOpacity 
              style={[styles.refreshButton, { borderColor: currentTheme.primary, backgroundColor: currentTheme.surface }]}
              onPress={onRefresh}
              disabled={refreshing}
            >
              <MaterialIcons name="refresh" size={24} color={currentTheme.primary} />
          ...
          <View style={[styles.sectionContainer, { backgroundColor: currentTheme.surface }]}>
            <View style={styles.sectionHeader}>
              <Text style={[styles.sectionTitle, { color: currentTheme.text }]}>Top Performers</Text>
          ...
          <View style={[styles.sectionContainer, { backgroundColor: currentTheme.surface }]}>
            <View style={styles.sectionHeader}>
              <Text style={[styles.sectionTitle, { color: currentTheme.text }]}>My Recent Workouts</Text>
              <TouchableOpacity 
