  ...
  const BadgeContent = ({ isModal = false }) => (
    <View style={[
      ...
      {isModal && badge.requirements && (
        <Text style={[styles.modalRequirements, { color: currentTheme.textSecondary, backgroundColor: currentTheme.background }]}>
          Requirements: {badge.requirements}
        </Text>
      )}
      {isModal && badge.earnedDate && (
        <Text style={[styles.modalEarnedDate, { color: currentTheme.textMuted }]}>
          ...
          <View style={[styles.modalOverlay, { backgroundColor: currentTheme.modalOverlay }]}>
            <View style={[styles.modalContent, { backgroundColor: currentTheme.surface }]}>
              <View style={styles.modalHeader}>
                <Text style={[styles.modalTitle, { color: currentTheme.text }]}>Badge Details</Text>
                <TouchableOpacity 
